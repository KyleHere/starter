...
//Understand
  //function named chooseyEndings
    //accepts an array of words (arr) AND (suffix) string
  //return a NEW array containing words that end in the given suffix
  //if the value passed is not an array, return an empty array
//Plan
  //function chooseyEndings(arr, suffix){}
  //filter loop (currentWord)
    //return if currentWord.includes(suffix)
